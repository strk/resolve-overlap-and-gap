...
-- SELECT function to resolve overlap and gap in the function in test_data.overlap_gap_input_t1 which we just testet for overlap
SELECT resolve_overlap_gap_start('test_data.overlap_gap_input_t2','c1','geom',4258,false,'test_topo_t2',0.000001,5,4);
...
-- SELECT function to resolve overlap and gap in the function in test_data.overlap_gap_input_t1 which we just testet for overlap
SELECT resolve_overlap_gap_start('test_data.overlap_gap_input_t3','c1t3','geo',25833,true,'test_topo_t3',1,5,4);
